...
@section('titlepage', 'Tambah Kantor | Mitra')
        ...
        <div class="container-lg py-3 content-wrapper">
            ...
            <div class="edit-wrapper d-lg-flex">
                <div class="data me-1 me-lg-4 bg-white rounded-15 p-2 mb-4 mb-lg-0">
                    ...
                    <form action="/mt/kantor/post" method="POST" class="">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat" cols="30" rows="5"
                                onkeyup="updateAlamat(this.value)">{{ old('alamat') }}</textarea>
                            @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control rounded-15 @error('notelp') is-invalid @enderror"
                                id="notelp" name="notelp" value="{{ old('notelp') }}" min="0"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select rounded-15 @error('status') is-invalid @enderror"
                                ...
                                <option @if (old('status') == 'kantor pusat') {{ 'selected ' }} @endif value="kantor pusat">
                                    Kantor Pusat</option>
                                <option @if (old('status') == 'kantor cabang') {{ 'selected ' }} @endif value="kantor cabang">
                ...
                <div class="preview">
                    ...
                    <div class="shadow bg-white rounded-20">
                        ...
                        <div class="content p-3">
                            <div>
                                <h4 class="fw-bold" id="status_value">Nama</h4>
                            </div>
                            <table>
                                <tr>
                                    <td>
