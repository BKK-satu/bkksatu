                    ...
                    <form action="" method="POST" class="">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control rounded-15" id="nama" placeholder="Nama..."
                                onkeyup="updateNama(this.value)">
                        </div>
                        <div class="mb-3">
                            <label for="nis" class="form-label">NIS</label>
                            <input type="number" class="form-control rounded-15" id="nis" onkeyup="updateNis(this.value)"
                                maxlength="12">
                        </div>
                        <div class="mb-3">
                            <label for="nisn" class="form-label">NISN</label>
                            <input type="number" class="form-control rounded-15" id="nisn" onkeyup="updateNisn(this.value)"
                                maxlength="12">
                        </div>
                        <div class="mb-3">
